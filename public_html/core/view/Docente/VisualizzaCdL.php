<?php
/**
 * La view consente ad un Docente di visualizzare tutti i CdL presenti nel sistema SimplEx
                        ...
                        <div id="tabella_2_wrapper" class="dataTables_wrapper no-footer">
                            <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                ...
                                foreach ($cdls as $c) {
                                    ...
                                    printf("<td class=\"sorting_1\"><a class=\"btn default btn-xs green-stripe\" href=\"/docente/cdl/%s\">%s</a></td>", $c->getMatricola(), $c->getNome());
