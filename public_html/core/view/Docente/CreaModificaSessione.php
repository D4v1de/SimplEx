                        ...
                        <div id="tabella_test_wrapper" class="dataTables_wrapper no-footer" >
                            <table class="table table-striped table-bordered table-hover dataTable no-footer"
                                ...
                                <tr role="row">
                                    ...
                                    ?>
                                    <th class="sorting-disabled" tabindex="0" aria-controls="sample_2" rowspan="1"
                ...
                <div id="tabella_studenti_wrapper" class="dataTables_wrapper no-footer">
                    <table class="table table-striped table-bordered table-hover dataTable no-footer "
                        ...
                        <tr role="row">
                            ...
                            <th class="sorting-disabled" tabindex="0" aria-controls="sample_2" rowspan="1" colspan="1"
                                aria-label="
                                                    Email
                                                    : activate to sort column ascending" style="width: 181px;">
                                Matricola
...
<script>
    function pig() {
        var vaiA = "/docente/corso/<?php echo $idCorso; ?>/sessione/<?php echo $idSessione; ?>/filtrotests/vai/" + $("#maxTest").val();
        $.ajax({
            url: vaiA, success: function (result) {
                $("#divTest").html(result);
            }
        });
    }
