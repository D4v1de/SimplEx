...
class CorsoModel extends Model {
    ...
    /**
     * Restituisce corsi dato utente
     * @param Utente utente
     * @return Corso[]
     */
    public function getMyCourses($utente) {
        return ($utente->getTipologia() == "Studente" ? $this->getAllCorsiByStudente($utente->getMatricola()) : $this->getAllCorsiByDocente($utente->getMatricola()));
    }
}
