...
class TestModel extends Model {
    ...
    private static $GET_TEST_SESSIONE_VALUTATIVA = "SELECT t.* FROM `sessione_test` as s_t, `test` as t , `sessione` as s WHERE s_t.test_id = t.id AND s.tipologia='Valutativa' AND s.corso_id = '%d' AND s_t.sessione_id = s.id";
